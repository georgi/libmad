...
pkgdatadir = $(datadir)/libmad
pkglibdir = $(libdir)/libmad
pkgincludedir = $(includedir)/libmad
top_builddir = .
...
DEP_FILES = ./$(DEPDIR)/bit.Plo ./$(DEPDIR)/decoder.Plo \
	./$(DEPDIR)/fixed.Plo ./$(DEPDIR)/frame.Plo \
	./$(DEPDIR)/huffman.Plo ./$(DEPDIR)/layer12.Plo \
	./$(DEPDIR)/layer3.Plo ./$(DEPDIR)/minimad.Po \
	./$(DEPDIR)/stream.Plo ./$(DEPDIR)/synth.Plo \
	./$(DEPDIR)/timer.Plo ./$(DEPDIR)/version.Plo
